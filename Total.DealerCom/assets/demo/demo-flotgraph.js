$(document).ready(function() {
    ...
    var plot = $.plot($("#sincos"),
        [{ data: sin, label: "sin(x)" }, { data: cos, label: "cos(x)" }], {
            ...
            colors: [Utility.getBrandColor('total-red'), Utility.getBrandColor('orange')],
            tooltip: true,
            tooltipOpts: {
                content: "x: %x, y: %y"
            }
    ...
    $.plot($("#multiple"), [
        ...
        xaxis: { tickColor: '#f5f5f5', font: {color: '#bdbdbd'}},
        colors: [Utility.getBrandColor('total-red'), Utility.getBrandColor('orange'), Utility.getBrandColor('blue'), Utility.getBrandColor('dark-blue'), Utility.getBrandColor('pink'), Utility.getBrandColor('purple')],
        tooltip: true,
        tooltipOpts: {
            content: "x: %x, y: %y"
        }
    ...
    var variance = $.plot($("#ordered"), dos, {
        ...
        colors: [Utility.getBrandColor('total-red'), Utility.getBrandColor('orange'), Utility.getBrandColor('blue')],
        tooltip: true,
        tooltipOpts: {
            content: "x: %x, y: %y"
        },
    ...
    // data
    var datax = [
        { label: "Series1",  data: 10, color: Utility.getBrandColor('total-red')},
        { label: "Series2",  data: 30, color: Utility.getBrandColor('blue')},
        { label: "Series3",  data: 90, color: Utility.getBrandColor('orange')},
        { label: "Series4",  data: 70, color: Utility.getBrandColor('dark-blue')},
        { label: "Series5",  data: 80, color: Utility.getBrandColor('pink')},
        { label: "Series6",  data: 110, color: Utility.getBrandColor('purple')}
    ];
