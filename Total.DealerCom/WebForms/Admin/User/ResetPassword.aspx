<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ResetPassword.aspx.cs"
    Inherits="TotalDealer_2008.User.ResetPassword" Theme="Red Glass" %>
...
<body style="background-color: White">
    ...
    <br />
    <div align="center">
        <dxrp:ASPxRoundPanel ID="ASPxRoundPanel1" runat="server" Width="300px" Font-Size="Small"
            HeaderText="Reset Password:" Height="110px" 
            ...
            <PanelCollection>
                <dxp:PanelContent>
                    <table style="height: 55px; text-align: left">
                        <tr>
                            <td nowrap="nowrap">
                                <asp:Label ID="Label2" Text="User Id (outlet number)" runat="server" Font-Names="Tahoma" 
                                    Font-Size="Small" Width="145px"></asp:Label>
                            </td>
                            <td>
                    ...
                    <table>
                        <tr>
                            <td>
                                <asp:Button CssClass="btn_grey" ID="btnReset" Text="Reset Password" runat="server"
                                    OnClick="btnReset_Click" BackColor="Gray" Width="150px"></asp:Button>
                            </td>
                            <td nowrap="nowrap">
